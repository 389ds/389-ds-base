...
import { valid_dn, listsEqual, valid_filter } from "../tools.jsx";
            ...
            <Modal
                ...
                actions={[
                    <Button
                        ...
                        isDisabled={!valid_filter(groupFilter)}
                    >
                    ...
                    <Grid className="ds-margin-top">
                        ...
                        <GridItem span={9}>
                            <TextInput
                                ...
                                name="groupFilter"
                                onChange={(e, str) => { handleFieldChange(e) }}
                                validated={!valid_filter(groupFilter) ? ValidatedOptions.error : ValidatedOptions.default}
                            />
                            <FormHelperText  >
                                {_("Value must be a valid LDAP filter")}
                            </FormHelperText>
                        </GridItem>
                    </Grid>
                </Form>
