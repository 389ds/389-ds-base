...
arg_to_attr = {
        ...
        'disable_dynamic_lists': 'nsslapd-dynamic-lists-enabled',
...
def create_parser(subparsers):
    ...
    set_db_config_parser.add_argument('--disable-dynamic-lists', action='store_false', help='Disables dynamic lists')
