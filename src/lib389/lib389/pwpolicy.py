...
class PwPolicyManager(object):
    ...
    def resolve_user_dn(self, basedn, user_type, selector):
    ...
    def get_effective_policy(self, basedn, user_type, selector):
        """Resolve the effective password policy for a user account."""
        user_dn = self.resolve_user_dn(basedn, user_type, selector)
