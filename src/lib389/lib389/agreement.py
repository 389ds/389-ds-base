...
class AgreementLegacy(object):
    ...
    def getProperties(self, agmnt_dn=None, properties=None):
        ...
        :supported properties are:
                ...
                RA_DESCRIPTION, RA_SCHEDULE, RA_TRANSPORT_PROT, RA_TRANSPORT_URI,
                RA_TRANSPORT_CA_URI, RA_FRAC_EXCLUDE, RA_FRAC_EXCLUDE_TOTAL_UPDATE,
                RA_FRAC_STRIP, RA_CONSUMER_PORT, RA_CONSUMER_HOST,
                RA_CONSUMER_TOTAL_INIT, RA_TIMEOUT, RA_CHANGES
        """
