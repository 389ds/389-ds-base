...
def test_nsmatchingrule_vs_schema(topo):
    ...
    range/order comparisons still use integer semantics even if the schema
    equality rule is overridden to a lexicographic matching rule.
    ...
    expected_log_msg = (
        'Ordering parentid index with the configured matching rule '
        '"integerOrderingMatch" but the matching rule is not compatible '
