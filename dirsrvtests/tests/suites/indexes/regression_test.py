...
def test_update_eq_index_after_deleting_and_readding_attribute_in_one_step(topo):
    ...
    #
    # Use of modify_s necessary as the test case demands delete and add operation to be done in one operation
    #
    try:
        topo.standalone.modify_s(user.dn, [(ldap.MOD_DELETE,
                                              'mail',
                                              b'user0099@dev.null'),
                                             (ldap.MOD_DELETE,
                                              'mail',
                                              b'alias@dev.null'),
                                             (ldap.MOD_ADD,
                                              'mail', b'user0099@dev.null')], escapehatch='i am sure')
