...
def test_postread_ctrl_modify(topology_st):
    ...
    :steps:
        ...
        4. Verify PostReadControl response contains the updated entry data
    ...
    :expectedresults:
        ...
        4. Control response contains updated description and cn attributes
    ...
    pr_ctrl = PostReadControl(criticality=True, attrList=['description'])
    ...
    assert 'description' in resp_ctrls[0].entry, "Control should return requested attributes"
