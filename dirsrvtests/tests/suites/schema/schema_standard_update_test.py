...
SYNTAX 1.3.6.1.4.1.1466.115.121.1.26 X-ORIGIN 'user defined' )""")
    ...
    # Assuming you want to change the owner/group to the user/group of 'dirsrv'
    # First, you need to find the UID (User ID) and GID (Group ID) for 'dirsrv'
    dirsrv_uid = pwd.getpwnam('dirsrv').pw_uid
    dirsrv_gid = grp.getgrnam('dirsrv').gr_gid

    # Change the ownership to dirsrv
