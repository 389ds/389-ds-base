...
def test_setup(request, topology_m2):
...
def test_schema_update_policy_allow(topology_m2, test_setup):
...
def test_schema_update_policy_reject(topology_m2, test_setup, temporary_oc2):
