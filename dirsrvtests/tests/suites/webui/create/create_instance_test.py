...
def test_no_instance(topology_st, page, setup_page):
...
def test_instance_button_disabled_passwd_short(topology_st, page, setup_page):
...
def test_create_instance_without_database(topology_st, page, setup_page):
...
def test_create_instance_database_suffix_entry(topology_st, page, setup_page):
    ...
    frame.click('input[placeholder="e.g. dc=example,dc=com"]')
...
def test_create_instance_database_sample_entries(topology_st, page, setup_page):
