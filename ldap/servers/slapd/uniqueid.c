...
Slapi_UniqueID *slapi_uniqueIDNew ()
{
	...
	if (uId == NULL)
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDNew: "
...
int slapi_uniqueIDCompare (const Slapi_UniqueID *uId1, const Slapi_UniqueID *uId2){
	...
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDCompare: "
...
int slapi_uniqueIDFormat (const Slapi_UniqueID *uId, char **buff){
	...
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDFormat: "
						 "NULL argument passed to the function.\n");
        return UID_BADDATA;
	}
...
int slapi_uniqueIDScan (Slapi_UniqueID *uId, const char *buff){
    if (uId == NULL || buff == NULL)
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDScan: "
						 "NULL argument passed to the function.\n");
        return UID_BADDATA;
	}
