...
vlvIndex_createfilename(struct vlvIndex* pIndex, char **ppc)
{
    ...
    *p= '\0';
    ...
    {
        LDAPDebug(LDAP_DEBUG_ERR, "vlvIndex_createfilename - Couldn't generate valid filename from Virtual List View Index Name (%s).  Need some alphabetical characters.\n", pIndex->vlv_name, 0, 0);
        filenameValid= 0;
    }
