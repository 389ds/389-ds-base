...
int uniqueIDGenInit (const char *configDir, const Slapi_DN *configDN, PRBool mtGen)
{
	...
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDGenInit: "
...
int slapi_uniqueIDGenerate (Slapi_UniqueID *uId){
    ...
    if (uId == NULL)
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDGenerate: "
									...
									const void *name, int namelen)
{
	...
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, MODULE, "uniqueIDGenerateMT: "
