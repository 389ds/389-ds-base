...
testentry_scramble( char **entry, unsigned long *len )
{
	...
	slapi_log_error(SLAPI_LOG_PLUGIN, LOG_DEBUG, "testentry_scramble",  
...
testentry_unscramble( char **entry, unsigned long *len )
{
	...
	slapi_log_error(SLAPI_LOG_PLUGIN, LOG_DEBUG, "testentry_unscramble",
...
testentry_init(Slapi_PBlock *pb)
{
	...
	if ( slapi_pblock_set( pb, SLAPI_PLUGIN_VERSION, 
		...
		slapi_log_error(SLAPI_LOG_PLUGIN, LOG_DEBUG, "testentry_init",
