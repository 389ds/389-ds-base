...
void
view_set_plugin_identity(void *identity)
{
    view_plugin_identity = identity;
}

void *
view_get_plugin_identity(void)
{
...
void
views_read_lock(void)
{
    slapi_rwlock_rdlock(g_views_cache_lock);
}

void
views_write_lock(void)
{
...
*/
static int
views_start(Slapi_PBlock *pb __attribute__((unused)))
{
    int ret = SLAPI_PLUGIN_SUCCESS;
 ...
 */
static int
_internal_api_views_entry_exists(char *view_dn, Slapi_Entry *e)
{
    return _internal_api_views_entry_exists_general(view_dn, e, NULL);
}

static int
_internal_api_views_entry_dn_exists(char *view_dn, char *e_dn)
{
    return _internal_api_views_entry_exists_general(view_dn, NULL, e_dn);
}

static int
_internal_api_views_entry_exists_general(char *view_dn, Slapi_Entry *e, char *e_dn)
{
    int ret = SLAPI_PLUGIN_SUCCESS;
    viewEntry *view;
    char *dn;
...
*/
static int
views_close(Slapi_PBlock *pb __attribute__((unused)))
{
    void **statechange_api;
 ...
 */
int
views_cache_view_compare(const void *e1, const void *e2)
{
    int ret;
 ...
 */
int
views_cache_dn_compare(const void *e1, const void *e2)
{
    int ret;
...
*/
viewEntry *
views_cache_view_index_bsearch(const char *key, int lower, int upper)
{
    viewEntry *ret = 0;
    int index = 0;
    int compare_ret = 0;
...
*/
static viewEntry *
views_cache_find_view(char *view)
{
...
*/
static void
views_cache_discover_parent(viewEntry *pView)
{
    viewEntry *head = theCache.pCacheViews;
    viewEntry *current;
    int found = 0;
...
*/
static void
views_cache_discover_parent_for_children(viewEntry *pView)
{
    int ii = 0;
...
*/
static void
views_cache_discover_children(viewEntry *pView)
{
    viewEntry *head = theCache.pCacheViews;
    viewEntry *current;
    int child_count = 0;
...
static void
views_cache_discover_view_scope(viewEntry *pView)
{
...
*/
static void
views_cache_create_applied_filter(viewEntry *pView)
{
    viewEntry *current = pView;
 ...
 */
static void
views_cache_create_exclusion_filter(viewEntry *pView)
{
    /*
    viewEntry *current = pView;
...
Slapi_Filter *
views_cache_create_descendent_filter(viewEntry *ancestor, PRBool useEntryID)
{
    int child_count = 0;
    Slapi_Filter *pOrSubFilter = 0;
...
*/
static int
views_cache_build_view_list(viewEntry **pViews)
{
    int ret = SLAPI_PLUGIN_SUCCESS;
...
static int
views_dn_views_cb(Slapi_Entry *e, void *callback_data)
{
...
static int
views_cache_add_dn_views(char *dn, viewEntry **pViews)
{
...
*/
static void
views_cache_add_ll_entry(void **attrval, void *theVal)
{
...
*/
static void
views_update_views_cache(Slapi_Entry *e, char *dn __attribute__((unused)), int modtype, Slapi_PBlock *pb, void *caller_data __attribute__((unused)))
{
    char *pDn;
    viewEntry *theView;
    viewEntry *current;
 ...
 */
static int
view_search_rewrite_callback(Slapi_PBlock *pb)
{
    int ret = -1;
    char *base = 0;
 ...
 */
static void
views_cache_backend_state_change(void *handle __attribute__((unused)), char *be_name __attribute__((unused)), int old_be_state __attribute__((unused)), int new_be_state __attribute__((unused)))
{
