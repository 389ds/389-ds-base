...
int whoami_exop( Slapi_PBlock *pb )
{
	...
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, PLUGIN_NAME, "Could not get client_dn" );
	...
	{
		slapi_log_error(SLAPI_LOG_FATAL, LOG_ERR, PLUGIN_NAME, "Could not set return values" );
