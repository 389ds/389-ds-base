...
static int numstr_filter_ava(Slapi_PBlock *pb, struct berval *bvfilter, Slapi_Value **bvals, int ftype, Slapi_Value **retVal);
static int numstr_filter_sub(Slapi_PBlock *pb, char *initial, char **any, char * final, Slapi_Value **bvals);
static int numstr_values2keys(Slapi_PBlock *pb, Slapi_Value **val, Slapi_Value ***ivals, int ftype);
static int numstr_assertion2keys(Slapi_PBlock *pb, Slapi_Value *val, Slapi_Value ***ivals, int ftype);
static int numstr_assertion2keys_sub(Slapi_PBlock *pb, char *initial, char **any, char * final, Slapi_Value ***ivals);
...
static struct mr_plugin_def mr_plugin_table[] = {
    {
        ...
        {"numericStringMatch-mr",
         VENDOR,
         DS_PACKAGE_VERSION,
         "numericStringMatch matching rule plugin"}, /* plugin desc */
    ...
    },
    {
        ...
        {"numericStringOrderingMatch-mr",
         VENDOR,
         DS_PACKAGE_VERSION,
         "numericStringOrderingMatch matching rule plugin"}, /* plugin desc */
    ...
    },
    {
        {NUMERICSTRINGSUBSTRINGSMATCH_OID,
         ...
         0 /* not obsolete */,
         numericStringSubstringsMatch_syntaxes}, /* matching rule desc */
        {
            "numericStringSubstringsMatch-mr",
            VENDOR,
            DS_PACKAGE_VERSION,
            "numericStringSubstringsMatch matching rule plugin"}, /* plugin desc */
...
numstr_init(Slapi_PBlock *pb)
{
    ...
    slapi_log_err(SLAPI_LOG_PLUGIN, SYNTAX_PLUGIN_SUBSYSTEM, "=> numstr_init\n");
    ...
    slapi_log_err(SLAPI_LOG_PLUGIN, SYNTAX_PLUGIN_SUBSYSTEM, "<= numstr_init %d\n", rc);
    return (rc);
}

static int
numstr_filter_ava(Slapi_PBlock *pb, struct berval *bvfilter, Slapi_Value **bvals, int ftype, Slapi_Value **retVal)
{
