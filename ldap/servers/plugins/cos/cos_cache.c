...
void cos_cache_backend_state_change(void *handle, char *be_name, int old_be_state, int new_be_state);
...
*/
static int
cos_cache_build_definition_list(cosDefinitions **pDefs, int *vattr_cacheable)
{
    int ret = 0;
...
static int
cos_cache_add_dn_defs(char *dn, cosDefinitions **pDefs)
{
...
*/
static int
cos_dn_tmpl_entries_cb(Slapi_Entry *e, void *callback_data)
{
    cosAttrValue *pDn = 0;
...
static int
cos_cache_add_dn_tmpls(char *dn, cosAttrValue *pCosSpecifier, cosAttrValue *pAttrs, cosTemplates **pTmpls)
{
    void *plugin_id;
    int scope;
...
*/
static void
cos_cache_del_attrval_list(cosAttrValue **pVal)
{
...
*/
static void
cos_cache_add_ll_entry(void **attrval, void *theVal, int (*compare)(const void *elem1, const void *elem2))
{
...
*/
int
cos_cache_getref(cos_cache **pptheCache)
{
    int ret = -1;
...
*/
int
cos_cache_addref(cos_cache *ptheCache)
{
    int ret = 0;
...
*/
int
cos_cache_release(cos_cache *ptheCache)
{
    int ret = 0;
    int destroy = 0;
...
*/
static void
cos_cache_del_attr_list(cosAttributes **pAttrs)
{
...
*/
static void
cos_cache_del_schema(cosCache *pCache)
{
    char *pLastName = 0;
    int attr_index = 0;
...
*/
static int
cos_cache_add_attr(cosAttributes **pAttrs, char *name, cosAttrValue *val)
{
    int ret = 0;
...
*/
static int
cos_cache_add_tmpl(cosTemplates **pTemplates, cosAttrValue *dn, cosAttrValue *objclasses, cosAttrValue *pCosSpecifier, cosAttributes *pAttrs, cosAttrValue *cosPriority)
{
    int ret = 0;
...
*/
static int
cos_cache_attrval_exists(cosAttrValue *pAttrs, const char *val)
{
    int ret = 0;
...
static int
cos_cache_vattr_get(vattr_sp_handle *handle __attribute__((unused)),
                    vattr_context *c,
                    Slapi_Entry *e,
                    char *type,
...
static int
cos_cache_vattr_compare(vattr_sp_handle *handle __attribute__((unused)),
                        vattr_context *c,
                        Slapi_Entry *e,
                        char *type,
 ...
 */
static int
cos_cache_vattr_types(vattr_sp_handle *handle __attribute__((unused)),
                      Slapi_Entry *e,
...
*/
static int
cos_cache_query_attr(cos_cache *ptheCache, vattr_context *context, Slapi_Entry *e, char *type, Slapi_ValueSet **out_attr, Slapi_Value *test_this, int *result, int *props, int *indirect_cos)
{
    int ret = -1;
    cosCache *pCache = (cosCache *)ptheCache;
    char *pDn = 0;
...
*/
static int
cos_cache_find_attr(cosCache *pCache, char *type)
{
...
*/
static int
cos_cache_schema_check(cosCache *pCache, int attr_index, Slapi_Attr *pObjclasses)
{
...
*/
static int
cos_cache_schema_build(cosCache *pCache)
{
...
static int
cos_cache_index_all(cosCache *pCache)
{
    int ret = -1;
...
*/
static int
cos_cache_total_attr_count(cosCache *pCache)
{
    int count = 0;
    cosDefinitions *pDef = pCache->pDefs;
...
static int
cos_cache_attr_compare(const void *e1, const void *e2)
{
    int com_Result;
...
static int
cos_cache_string_compare(const void *e1, const void *e2)
{
    if (!e1 && e2) {
        return 1;
    } else if (e1 && !e2) {
...
static int
cos_cache_template_index_compare(const void *e1, const void *e2)
{
    int ret = 0;
...
*/
static int
cos_cache_template_index_bsearch(const char *dn)
{
    int ret = 0;
    cosCache *pCache;
...
*/
static int
cos_cache_attr_index_bsearch(const cosCache *pCache, const cosAttributes *key, int lower, int upper)
{
    int ret = -1;
    int index = 0;
...
*/
void
cos_cache_change_notify(Slapi_PBlock *pb)
{
    const char *dn;
    Slapi_DN *sdn = NULL;
    int do_update = 0;
...
*/
static int
cos_cache_backwards_stricmp_and_clip(char *s1, char *s2)
{
    int ret = 0;
    int s1len = 0;
    int s2len = 0;
...
static int
cos_cache_follow_pointer(vattr_context *c, const char *dn, char *type, Slapi_ValueSet **out_vs, Slapi_Value *test_this, int *result, int flags)
{
    int ret = -1; /* assume failure */
    Slapi_PBlock *pDnSearch = 0;
 ...
 */
void
cos_cache_backend_state_change(void *handle __attribute__((unused)),
 ...
 */
static int
cos_cache_entry_is_cos_related(Slapi_Entry *e)
{
