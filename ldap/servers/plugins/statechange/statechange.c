...
*/
int
statechange_init(Slapi_PBlock *pb)
{
...
*/
static int
statechange_start(Slapi_PBlock *pb __attribute__((unused)))
{
    int ret = SLAPI_PLUGIN_SUCCESS;
...
*/
static int
statechange_close(Slapi_PBlock *pb __attribute__((unused)))
{
...
static int
statechange_mod_post_op(Slapi_PBlock *pb)
{
    return statechange_post_op(pb, LDAP_CHANGETYPE_MODIFY);
}

static int
statechange_modrdn_post_op(Slapi_PBlock *pb)
{
    return statechange_post_op(pb, LDAP_CHANGETYPE_MODDN);
}

static int
statechange_add_post_op(Slapi_PBlock *pb)
{
    return statechange_post_op(pb, LDAP_CHANGETYPE_ADD);
}

static int
statechange_delete_post_op(Slapi_PBlock *pb)
{
...
*/
static int
statechange_post_op(Slapi_PBlock *pb, int modtype)
{
...
static int
_statechange_register(char *caller_id, char *dn, char *filter, void *caller_data, notify_callback func)
{
...
static void *
_statechange_unregister(char *dn, char *filter, notify_callback thefunc)
{
    void *ret = NULL;
    SCNotify *func = NULL;
...
static void
_statechange_unregister_all(char *caller_id, caller_data_free_callback callback)
{
    SCNotify *notify = head;
...
static SCNotify *
statechange_find_notify(char *dn, char *filter, notify_callback func)
{
    SCNotify *notify = head;
    SCNotify *start_notify = head;
 ...
 */
static void
_statechange_vattr_cache_invalidator_callback(Slapi_Entry *e,
